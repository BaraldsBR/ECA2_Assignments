...
module fir1_100
    ...
    , input wire signed [17:0] c$arg

      // Outputs
    , output wire signed [17:0] o
    );
  // Filters1_100.hs:13:1-94
  wire [1799:0] c$ds_app_arg;
  // Filters1_100.hs:13:1-94
 ...
 18'sd0,   18'sd0,   18'sd0,   18'sd0};
  ...
  for (i = 0; i < 100; i = i + 1) begin : zipWith
    ...
    assign result = (((~ (| (c$app_arg))) | (& (c$app_arg))) == 1'b1) ? ($signed((c$bv[0+:18]))) : c$case_alt;

    assign c$case_alt = (( c$app_arg_0[5-1] ) == 1'b0) ? 18'sd131071 : -18'sd131072;

    assign c$bv_0 = (rR);

    assign c$app_arg = ({((( c$bv_0[31-1] ))),c$app_arg_0});

    assign c$app_arg_0 = rL;
    ...
    assign c$ds_app_arg[i*18+:18] = c$n;
  end
  endgenerate
  // zipWith end
